...
// COMPONENTS
import RootLayout, { action as searchAction } from './components/RootLayout';
...
const router = createBrowserRouter(createRoutesFromElements(
  <Route path='/' element={<RootLayout />}>
    ...
    <Route path='/search/:id' element={<MoviesContainer />} /*loader={initMoviesLoader}*/ action={searchAction}/>
